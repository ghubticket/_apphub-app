const STATUS_DETAIL_MESSAGES: Record<string, string> = {
    ...
    cc_rejected_bad_filled_security_code: 'Código de segurança incorreto. Confira os dígitos no verso do cartão.',
    ...
    required_call_for_authorize: 'Transação necessita autorização do banco emissor. Entre em contato com o banco.',
    ...
    cc_rejected_duplicated_payment: 'Pagamento duplicado para esta compra. Verifique lançamentos anteriores.',
    ...
    cc_rejected_3ds_challenge: 'Verificação 3D Secure não concluída. Tente novamente e finalize a autenticação.',
    ...
    rejected_by_regulations: 'Pagamento recusado por políticas do emissor. Entre em contato com o banco.',
    rejected_insufficient_data: 'Pagamento recusado. Complete os dados do titular e tente novamente.',
    insufficient_amount: 'Pagamento recusado por saldo insuficiente.',
    cc_amount_rate_limit_exceeded: 'Limite de transações excedido. Tente novamente mais tarde ou com outro cartão.',
    cc_rejected_high_risk_fraud: 'Pagamento recusado por suspeita de fraude. Utilize outro cartão ou método.',
};
