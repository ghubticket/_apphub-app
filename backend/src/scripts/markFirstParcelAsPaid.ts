 ...
 * 
 * Uso: npm run mark-first-parcel-paid
 *   ou: npx ts-node src/scripts/markFirstParcelAsPaid.ts
 * 
 * Este script:
...
// Tentar carregar do diretório raiz do backend
const envPath = path.resolve(__dirname, '../../.env');
dotenv.config({ path: envPath });
// Também tentar sem caminho específico (usa padrão do projeto)
dotenv.config();

// Importar modelos
import ParcelledOrder from '../models/ParcelledOrder';
