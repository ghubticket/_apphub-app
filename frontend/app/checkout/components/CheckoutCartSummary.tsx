    ...
    return (
        <div className="rounded-3xl border border-[#ded7ca] bg-white p-6 shadow-[0_25px_55px_-30px_rgba(20,20,32,0.35)]">
                    ...
                    >
                        <div className="flex items-start justify-between gap-4">
                            <div className="space-y-1">
                                ...
                                <p className="text-base font-semibold uppercase tracking-[0.15em] text-[#1a1a1d]">{item.name}</p>
                        ...
                        <div className="mt-4 grid gap-3 text-sm text-[#4c4c55] md:grid-cols-2">
                            <div>
                                <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#7d796c]">Quantidade</span>
                                <p className="mt-1 text-sm font-semibold text-[#1a1a1d]">{item.quantity} ingresso(s)</p>
                            </div>
                            <div>
                                <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#7d796c]">Subtotal</span>
                            ...
                            {item.platformFeeValue > 0 || item.fixedFeeValue > 0 ? (
                                <div className="md:col-span-2">
                                    <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#7d796c]">Taxas</span>
            ...
            <footer className="mt-6 rounded-2xl border border-[#ede5d8] bg-white px-5 py-4">
                <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[#7d796c]">Total a pagar</span>
