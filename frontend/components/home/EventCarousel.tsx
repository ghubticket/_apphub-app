            ...
            <div className="flex gap-6 overflow-x-auto pb-20 pt-2">
                {events.map((event) => {
                    ...
                    return (
                        ...
                        >
                            <article
                                className="group relative flex min-w-[280px] max-w-sm flex-col overflow-hidden rounded-3xl border border-[#ded7ca] bg-white/80 shadow-[0_24px_45px_-30px_rgba(20,20,32,0.55)] transition hover:-translate-y-1 hover:shadow-[0_40px_60px_-35px_rgba(20,20,32,0.6)] cursor-pointer"
                            >
