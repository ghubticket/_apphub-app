...
import { object, string, pipe, nonEmpty, minLength, maxLength, number, minValue, maxValue, regex, transform, optional, any } from 'valibot'
...
return isNaN(num) ? 0 : num
    ...
    events: optional(any()), // Array de eventos
    isActive: optional(string()), // Boolean como string
})
...
const PromoterCodeCreatePage = () => {
    ...
    const {
        ...
        defaultValues: {
            ...
            discountValue: '0', // String para compatibilidade com schema
            isActive: 'true', // String para compatibilidade com schema
        },
    })
...
return
            ...
            await promoterCodeService.create({
            ...
            alert(error.message || 'Erro ao criar código de promotor')
        }
    }
    ...
    return (
        <AdminOnly>
            <Card>
                <CardHeader title='Criar Código de Promotor' />
                <CardContent>
...
export default PromoterCodeCreatePage
